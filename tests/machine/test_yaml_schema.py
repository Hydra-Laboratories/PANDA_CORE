"""Tests for machine YAML schema validation."""
...
from src.machine.yaml_schema import MachineYamlSchema


def _valid_machine_dict() -> dict:
    return {
...
class TestMachineYamlSchema:

    def test_valid_machine_yaml_parses_all_fields(self):
        data = _valid_machine_dict()
        schema = MachineYamlSchema.model_validate(data)
    ...
    def test_invalid_homing_strategy_rejected(self):
        ...
        with pytest.raises(ValidationError):
            MachineYamlSchema.model_validate(data)
