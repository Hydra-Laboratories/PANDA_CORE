    ...
    if isinstance(raw_result, dict) and "measurements" in raw_result:
        ...
        return InstrumentMeasurement(
            ...
            metadata={
                ...
                "measurement_height": raw_result.get("measurement_height"),
                "indentation_limit": raw_result.get("indentation_limit"),
                "step_size": raw_result.get("step_size"),
                "force_limit": raw_result.get("force_limit"),
                "well_bottom_z": raw_result.get("well_bottom_z"),
                "instrument_name": instrument_name,
                "method_name": method_name,
            },
        )
