...
1. Each config loaded with details (machine working volume bounds, labware list with well counts, instruments with offsets, protocol steps)
...
2. Creates Gantry from raw machine config
