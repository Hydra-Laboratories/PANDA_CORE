...
- Merged latest `origin/staging` (`889ae99`) into `rail-labware` and resolved
  conflicts while preserving required gantry `gantry_type` fields.

## Changed Files

- `src/gantry/gantry_config.py`
- `src/gantry/__init__.py`
- `src/gantry/machine_geometry.py`
...
- `tests/gantry/test_machine_geometry.py`
...
- `python -m pytest tests/gantry/test_machine_geometry.py tests/validation/test_machine_structures.py tests/protocol_engine/test_mock_rail_guard_configs.py -q`
  - Result: `12 passed`
- `python -m pytest tests/gantry/test_yaml_schema.py tests/gantry/test_loader.py tests/gantry/test_gantry_config.py tests/validation/test_machine_structures.py tests/protocol_engine/test_mock_rail_guard_configs.py -q`
  - Result: `92 passed`
- `python -m pytest tests/gantry/test_yaml_schema.py tests/gantry/test_loader.py tests/gantry/test_gantry_config.py -q`
  - Result: `83 passed`
- `python -m pytest tests/setup/test_protocol_setup.py tests/setup/test_integration.py tests/board/test_board_loader.py tests/setup/test_calibrate_deck_origin.py tests/setup/test_calibrate_multi_instrument_board.py -q`
  - Result: `79 passed`
- `python -m pytest tests/setup/test_setup_imports.py tests/setup/test_calibrate_deck_origin.py -q`
  - Result: `20 passed`
...
- `python -m pytest -q`
  - Result: `1119 passed, 4 subtests passed`
...
- `python setup/validate_setup.py configs/gantry/cub_xl_sterling.yaml configs/deck/sterling_deck.yaml configs/protocol/sterling_vial_scan.yaml`
  - Result: `PASS`
- `python setup/validate_setup.py configs/gantry/cub_xl_sterling_3_instrument.yaml configs/deck/sterling_deck.yaml configs/protocol/sterling_2_instrument_vial_scan.yaml`
  - Result: `PASS`
